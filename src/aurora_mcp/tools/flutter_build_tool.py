...
class FlutterBuildTool:
    ...
    async def _build_flutter_bundle(self, project_dir: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Error building Flutter bundle: {e}"
            }
    ...
    async def _build_native_app(
        ...
        try:
            ...
            # Build with CMake
            build_result = await self._build_cmake_project(
                build_dir, target_arch
            )
    ...
    async def _generate_cmake_files(
        ...
        try:
            ...
            return {
                "success": True,
                "message": "CMake files generated successfully"
            }
            
        except Exception as e:
            return {
                "success": False,
                "error": f"Error generating CMake files: {e}"
            }
...
"""
    ...
    async def _build_cmake_project(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Error building CMake project: {e}"
            }
